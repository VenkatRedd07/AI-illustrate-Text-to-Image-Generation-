...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        >
            <p>Best Tool for Text to Image generator</p>
            <img src={assets.star_icon} alt=''/>
        </motion.div>
        <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center'>Turn text to <span className='text-blue-600' initial={{opacity:0}} animate={{opacity:1}} transition={{delay:0.4,duration:2}}>image</span>, in a split.</motion.h1>
        ...
        className='mt-2 text-neutral-600'>Generated images from AI IIlustrate</motion.p>
